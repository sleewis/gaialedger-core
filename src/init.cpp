 ...
 * between gaiad, and gaia-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/gaialedger/gaialedger>";
    const std::string URL_WEBSITE = "<https://gaialedger.io/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Gaialedger Developers", 2026)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Gaialedger useful. "
