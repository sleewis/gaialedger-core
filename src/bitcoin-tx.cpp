...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gaia-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gaia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gaia transaction") + "\n" +
              "  gaia-tx [options] -create [commands]   " + _("Create hex-encoded gaia transaction") + "\n" +
              "\n";
