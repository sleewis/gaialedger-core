...
const QString BITCOIN_IPC_PREFIX("gaia:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/gaia-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/gaia-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/gaia-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click gaia: links
...
//
// OSX-specific way of handling gaia: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in gaia: URIs
