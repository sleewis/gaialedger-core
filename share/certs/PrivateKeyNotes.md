...
unlocked to sign the Gaia-Qt.app bundle.
...
allowing somebody to distribute a Gaia-Qt.app or gaia-qt-setup.exe with a valid
...
that the gaia-qt.exe file inside the installer had not been tampered with.
